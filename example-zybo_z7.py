...
from litex_boards.targets.xilinx_zybo_z7 import *
...
#        Subsignal("mclk",    Pins("W26")),
        Subsignal("mclk",    Pins("V12")),
#        Subsignal("pdn",     Pins("V26")),
        Subsignal("pdn",     Pins("W16")),
#        Subsignal("i2c_sda", Pins("U26")),
        Subsignal("i2c_sda", Pins("J15")),
#        Subsignal("i2c_scl", Pins("T26")),
        Subsignal("i2c_scl", Pins("H15")),
#        Subsignal("sdin1",   Pins("T25")),
        Subsignal("sdin1",   Pins("V13")),
#        Subsignal("sdout1",  Pins("U25")),
        Subsignal("sdout1",  Pins("U17")),
#        Subsignal("lrck",    Pins("U24")),
        Subsignal("lrck",    Pins("T17")),
#        Subsignal("bick",    Pins("V24")),
        Subsignal("bick",    Pins("Y17")),
        IOStandard("LVCMOS33")
    ),
]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="LiteX SoC on Digilent Zybo Z7-10")
    ...
    parser.add_argument("--variant",             default="z7-10",                  help="Zybo board variant chip")
    parser.add_argument("--with-serial",         default="store_true",             help="Use discrete serial.")
