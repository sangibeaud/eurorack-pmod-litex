...
from litex_boards.targets.tul_pynq_z2 import *
...
#        Subsignal("mclk",    Pins("W26")),
        Subsignal("mclk",    Pins("Y18")),
#        Subsignal("pdn",     Pins("V26")),
        Subsignal("pdn",     Pins("Y19")),
#        Subsignal("i2c_sda", Pins("U26")),
        Subsignal("i2c_sda", Pins("Y16")),
#        Subsignal("i2c_scl", Pins("T26")),
        Subsignal("i2c_scl", Pins("Y17")),
#        Subsignal("sdin1",   Pins("T25")),
        Subsignal("sdin1",   Pins("U18")),
#        Subsignal("sdout1",  Pins("U25")),
        Subsignal("sdout1",  Pins("U19")),
#        Subsignal("lrck",    Pins("U24")),
        Subsignal("lrck",    Pins("W18")),
#        Subsignal("bick",    Pins("V24")),
        Subsignal("bick",    Pins("W19")),
        IOStandard("LVCMOS33")
    ),
]
